...
const CategoryIcons = {
  "Backend Development": (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="w-6 h-6 text-[var(--sec)] opacity-70"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5V19A9 3 0 0 0 15 21.84"/><path d="M21 5V8"/><path d="M21 12L18 17H22L19 22"/><path d="M3 12A9 3 0 0 0 14.59 14.87"/></svg>
  ),
...
const SkillsList = () => {
  ...
  const skills = {
    ...
    "Infrastructure & DevOps": [
      "Containerization and orchestration of backend services",
      "CI/CD pipelines for automated deployments",
      "Server setup and management using VPS with WHM/cPanel and Docker",
      "Monitoring and error tracking"
    ],
    "Web Development": [
      "Full-stack web apps using React, Next.js, and TypeScript",
      "Role-based admin panels and client-facing interfaces",
      "Responsive, user-friendly design focused on performance and usability",
      "Integration with backend services and secure data handling"
    ],
    "Mobile Development": [
